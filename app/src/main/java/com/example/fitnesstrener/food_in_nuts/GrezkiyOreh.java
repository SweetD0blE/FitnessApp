...
public class GrezkiyOreh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference = fStore.collection("Food_nuts_grezkyi_oreh").document("Ljv7itF7eYp4iyRKiyBW");
