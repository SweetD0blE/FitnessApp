...
public class Otjimaniya extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference = fStore.collection("Exercise_chest_otjimaniya").document("hYBDcAdR8dRySyRTcGUo");
