package com.example.fitnesstrener.exercise_in_chest;
...
public class JimShtangiLeja extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference = fStore.collection("Exercise_chest_jimshtangileja").document("UGlS8o7gBpkh4h7IaiJi");
