package com.example.fitnesstrener.food_in_dairy;
...
public class Kefir extends AppCompatActivity {
    ...
    DocumentReference documentReference = fStore.collection("Food_dairy_kefir").document("Z5SdbsT1HlnYcY2Ijwgr");
