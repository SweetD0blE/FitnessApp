...
public class Celnozernovoi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference = fStore.collection("Food_wheat_celnozernovoi").document("saIoCsoffmWUCTD3u4dH");
