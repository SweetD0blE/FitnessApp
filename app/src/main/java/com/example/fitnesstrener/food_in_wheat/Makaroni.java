...
public class Makaroni extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference = fStore.collection("Food_wheat_makaroni").document("wcv61Sn7IZ51E1Czsogl");
