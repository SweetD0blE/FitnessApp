...
public class Podtyagivaniya extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference = fStore.collection("Exercise_back_pullup").document("9mBa2TtmY9qwSNAXEwcB");
