...
public class TyagaVerhnegoBlocka extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference = fStore.collection("Exercise_back_tyagaverhnegobloka").document("r9fIGgWRPbWqLeXSUmop");
