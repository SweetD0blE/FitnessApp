...
public class SgibanieNog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference = fStore.collection("Exercise_legs_sgibanienog").document("F3b8u1EibjQE5ls57hAk");
