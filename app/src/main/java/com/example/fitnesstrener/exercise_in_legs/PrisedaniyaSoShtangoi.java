...
public class PrisedaniyaSoShtangoi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference = fStore.collection("Exercise_legs_prisedaniyasoshtangoi").document("bw3Q5WlKfvOLIcBGZdR6");
