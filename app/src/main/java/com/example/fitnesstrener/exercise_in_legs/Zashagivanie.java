...
public class Zashagivanie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference = fStore.collection("Exercise_legs_zashagivanie").document("D4csQMVNVKChNtKWWW1N");
