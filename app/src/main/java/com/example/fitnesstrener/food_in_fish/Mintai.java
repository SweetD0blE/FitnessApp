package com.example.fitnesstrener.food_in_fish;
...
public class Mintai extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference = fStore.collection("Food_fish_mintai").document("9ZoA1JgyKbO6s4ddB9wS");
