package com.example.fitnesstrener.exercise_in_cardio;
...
public class JumpWithSkakalka extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference = fStore.collection("Exercise_cardio_jumpwithskakalka").document("PdLedytOjE4ZH1Rueo8F");
