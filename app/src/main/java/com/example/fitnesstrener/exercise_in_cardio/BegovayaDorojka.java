...
public class BegovayaDorojka extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference = fStore.collection("Exercise_cardio_begovayadorojka").document("jx7bUg2cpwQveSch75Vw");
