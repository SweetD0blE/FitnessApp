...
public class Velotrenajor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference = fStore.collection("Exercise_cardio_velotrenajor").document("d6zTZBCE2Z5K4j1bsP1I");
