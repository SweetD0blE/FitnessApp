...
public class OntjimSkamii extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference = fStore.collection("Exercise_arms_otjimskamii").document("q0AlIgLUXavunISEeWk3");
