...
public class Molotok extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference = fStore.collection("Exercise_arms_molotok").document("NFKFDNZ6CswkVcfbtFxm");
