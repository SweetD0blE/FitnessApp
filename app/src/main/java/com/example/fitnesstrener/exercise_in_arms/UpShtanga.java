...
public class UpShtanga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference = fStore.collection("Exercise_arms_upshtanga").document("eSxWpJJ5SdyCTsGK8kqj");
